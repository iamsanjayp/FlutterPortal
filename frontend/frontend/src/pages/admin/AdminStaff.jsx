...
export default function AdminStaff() {
  ...
  const totalTeachers = users.filter(u => u.role_name === 'TEACHER' || u.role_id === 2).length;
  const totalAdmins = users.filter(u => u.role_name === 'ADMIN' || u.role_id === 3).length;
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage teacher and admin accounts</p>
        </div>
      ...
      {showCreate && (
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Create Staff</h3>
            ...
            {filteredUsers.map((user) => (
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-600">
                  <div className="font-mono">{user.staff_id || '-'}</div>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 rounded-md bg-orange-50 text-orange-700 hover:bg-orange-100 transition-colors text-sm"
                    >
                      Force Logout
                    </button>
                    <button
        ...
        {filteredUsers.length === 0 && (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500">
              {loading ? 'Loading staff...' : searchTerm ? 'No staff found' : 'No staff yet'}
            </p>
          </div>
        )}
      </div>

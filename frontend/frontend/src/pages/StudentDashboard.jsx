      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-md border border-gray-200 p-4">
              <div className="text-xs uppercase text-gray-400">Enrollment No</div>
              <div className="text-sm text-gray-700 mt-1">{user?.enrollment_no || "-"}</div>
            </div>
            <div className="rounded-md border border-gray-200 p-4">
              <div className="text-xs uppercase text-gray-400">Roll No</div>
              <div className="text-sm text-gray-700 mt-1">{user?.roll_no || "-"}</div>
            </div>
            <div className="rounded-md border border-gray-200 p-4">
              <div className="text-xs uppercase text-gray-400">Current Level</div>
              <div className="text-sm text-gray-700 mt-1">{level || "-"}</div>
            </div>
          </div>
